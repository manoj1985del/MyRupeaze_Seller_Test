...
var cardCompletedAppointments = document.getElementById("cardCompletedAppointment");
...
cardPendingAppointments.addEventListener("mouseenter", function () {
    cardPendingAppointments.classList.add("cardHover");
});

cardPendingAppointments.addEventListener("mouseleave", function () {
    cardPendingAppointments.classList.remove("cardHover");
});

cardPendingAppointments.addEventListener("click", function () {
    window.location.href = "pending_appointments.html?type=pending";
})

//Completed Appointments
cardCompletedAppointments.addEventListener("mouseenter", function () {
    cardCompletedAppointments.classList.add("cardHover");
});

cardCompletedAppointments.addEventListener("mouseleave", function () {
    cardCompletedAppointments.classList.remove("cardHover");
});

cardCompletedAppointments.addEventListener("click", function () {
...
//today appointments
cardTodayAppointment.addEventListener("mouseenter", function () {
    cardTodayAppointment.classList.add("cardHover");
});

cardTodayAppointment.addEventListener("mouseleave", function () {
    cardTodayAppointment.classList.remove("cardHover");
});
...
query.get()
    .then(function (snapshot) {
        ...
        txtTodayAppointments.textContent = todayAppointments.length.toString();
...
query.get()
    .then(function (snapshot) {
        ...
        hCompletedAppointments.textContent = appointments.length.toString();
