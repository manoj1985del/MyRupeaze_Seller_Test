...
function loadInvoice() {
  ...
  var txtSellerStateCode = document.getElementById("sellerStateCode");
  ...
  var txtOrderDate = document.getElementById("txtOrderDate");


  txtOrderId.textContent = invoice.order_id;
  var ord = invoice.order_date.toDate();
  var dd = ord.getDate();
  ...
  txtOrderDate.textContent = formattedDay;


  txtSellerStateCode.textContent = "GST State Code: " + gstMap.get(invoice.sellerState);
  ...
  //setting biil to details
  txtbilltoName.textContent = invoice.bill_to_name;
  txtbilltoAddressLine1.textContent = invoice.bill_to_address_line1;
  txtbilltoAddressLine2.textContent = invoice.bill_to_address_line2;
  txtbilltoAddressLine3.textContent = invoice.bill_to_address_line3;
  txtbilltoCity.textContent = invoice.bill_to_city;
  txtbilltoPhone.innerHTML = "<b>Contact No. </b>" + invoice.bill_to_phone;
  txtbilltoState.textContent = invoice.bill_to_state + " INDIA";
  txtbilltoLandmark.textContent = "Landmark: " + invoice.bill_to_landmark;
  txtbilltoPincode.textContent = "Pincode: " + invoice.bill_to_pin;
  ...
  var IGST = true;
  if (invoice.ship_to_state == invoice.sellerState) {
    IGST = false;
  ...
  for (var i = 0; i < productList.length; i++) {
    ...
    var gst = product.GST;
    var unitPrice = product.Offer_Price;
    var qty = product.Qty;
    ...
    netPayable += (product.Offer_Price * qty);
    ...
    headingTitle.textContent = product.Title;
    ...
    if (IGST) {
      ...
      gstSapn.textContent = gstAmount.toString() + " (" + product.GST.toString() + "%)";
    ...
    priceSpan.textContent = (product.Offer_Price * qty).toString();
